...
Contexto: Este README corresponde a `DataBases/SQL/ERD` (Diagramas entidad-relación). Aquí se ubican los diagramas y archivos relacionados con el modelado.

```
DataBases/SQL/ERD/
├── README.md
(diagramas ER y archivos relacionados)
```
