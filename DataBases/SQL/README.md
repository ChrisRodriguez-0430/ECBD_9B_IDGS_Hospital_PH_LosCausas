...
Contexto: Este README describe la estructura del directorio `DataBases/SQL`. La ruta es relativa a la raíz del repositorio y muestra las carpetas principales para objetos SQL.
