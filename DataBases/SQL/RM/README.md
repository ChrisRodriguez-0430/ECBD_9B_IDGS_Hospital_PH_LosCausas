...
Contexto: Este README corresponde a `DataBases/SQL/RM` (Modelo Relacional). Contiene scripts y documentación del modelo relacional.

```
DataBases/SQL/RM/
├── README.md
(scripts SQL, definiciones y documentación del modelo relacional)
```
