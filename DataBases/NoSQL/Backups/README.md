...
Contexto: Este README corresponde a `DataBases/NoSQL/Backups`. Muestra la ubicación actual y los elementos contenidoss dentro de este subdirectorio.

```
DataBases/NoSQL/Backups/
├── README.md
(aquí se almacenan copias de seguridad relacionadas con las bases NoSQL)
```
