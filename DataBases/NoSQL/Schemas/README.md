...
Contexto: Este README describe `DataBases/NoSQL/Schemas`. Aquí se mantienen los esquemas y ejemplos de estructuras de documentos NoSQL.

```
DataBases/NoSQL/Schemas/
├── README.md
(esquemas y plantillas de documentos NoSQL)
```
